...
def create_trained_policy(
    ...
    *,
    ...
    return _policy.Policy(
        ...
        tts_mode=tts_mode,
        tts_num_candidates=tts_num_candidates,
        tts_selection_ratio=tts_selection_ratio,
        tts_branch_ratio=tts_branch_ratio,
        tts_branch_noise_scale=tts_branch_noise_scale,
