...
if __name__ == "__main__":
    ...
    if not ckpt:
        raise RuntimeError("Set PRETRAINED_CHECKPOINT to run NeuroVLA demo code.")
    model = NeuroVLA.from_pretrained(ckpt).to(device)
    ...
    import pickle
    from omegaconf import OmegaConf
    samples_path = os.environ.get("NEUROVLA_SAMPLES_PATH", "samples_states.pkl")
